...
--10.06.2018 Tomislav; MID 39767 - adding new (calculated) fields 
...
from b2rl.dbo.PROVISIONS_REPORTS
...
--			nrt.id_cont, 
--			nrt.id_tec
--		from b2rl.dbo.PROVISIONS_NON_RETAIL nrt
...
--			rt.id_cont, 
--			rt.id_tec
--		from b2rl.dbo.PROVISIONS_RETAIL rt
