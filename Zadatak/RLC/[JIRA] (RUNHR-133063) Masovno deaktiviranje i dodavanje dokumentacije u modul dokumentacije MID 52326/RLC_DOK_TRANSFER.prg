* 20.06.2022 MR48906 g_igorp dodavanje flaga ima_u_sefu zbog dodavanja funkcionalnosti kloniranja polja "U SEFU"
...
ELSE
	...
	SCAN
		...
		SELECT _dok
		REPLACE dok_in_safe WITH pattern, popravil WITH GOBJ_Comm.GetUserName(), dat_poprave WITH DATETIME()
		
		IF _dok.dok_in_safe <> _dok_copy.dok_in_safe 
			lcXmlDiff = GF_CreateUpdateDifFieldsXML('DOKUMENT', "_dok", "_dok_copy")
		ELSE
			RETURN .F.
		ENDIF
	...
	loForm = GF_GetFormObject("frmPripDok2")
	loForm.Release
ENDIF