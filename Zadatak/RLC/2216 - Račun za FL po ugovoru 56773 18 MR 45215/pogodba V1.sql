--  27.07.2020 g_tomislav MR 45215 - zamijena LEFT JOIN dbo.zap_reg i LEFT JOIN dbo.zap_ner zner s outer apply dbo.gfn_zap_reg_single_per_contract2 i outer apply dbo.gfn_zap_ner_single_per_contract2
...
outer apply dbo.gfn_zap_reg_single_per_contract2(pog.id_cont) zreg
outer apply dbo.gfn_zap_ner_single_per_contract2(pog.id_cont) zner
