...
--05.03.2024 g_tomislav MID 51835 - dorada prikaza rep_ind za FINA partnere kojima je obavijest išla s FAK_LOBR_SSOFT_RLC
...
-- NIJE DOBRO JER KSADA SE PODESE VARIJABLE; DOLJE U JOIN-U SE GELDAJU SVI ZAPISI OD SVIH id_dxoc_template I TADA DOLAZI DO GREŠKE KOD KONVERTA STRINGA U INT 
...
left join dbo.xdoc_document xdd_OBV_IND on a.id_file = xdd_OBV_IND.doc_id and xdd_OBV_IND.id_xdoc_template = @id_xdoc_templateOBV_IND and xdd_OBV_IND.date_exported >= a.date_prepared
