...
SELECT 	
   ...
   12/obnaleto AS rtip_txt,
	...
	, can.id_zbirnik
	, ISNULL(dbo.gfn_GetOpcSt_dok(a.id_cont, b.nacin_leas), '0') as OpcSt_dok
	, pp2.id_terj,
	pp2.datum_dok,
	pp2.zap_obr,
	pp2.neto,
...
Select pp.id_terj,
	...
	--c.ndatum, 
	--c.id_rep_ind,
	--ISNULL(dbo.gfn_GetOpcSt_dok(pp.id_cont, pp.nacin_leas),'0') as OpcSt_dok,
	--a.Opc @OpcSt_dok as OpcSt_dok,
