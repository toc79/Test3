...
-- 29.12.2015 MatjazB; MID 54586 - added poknj_nezap_X fields
------------------------------------------------------------------------------------------------------------
...
RETURNS @Result TABLE
   ...
   Obrok1 decimal(18,2),
    ...
    kontakt varchar(45),
    gsm varchar(50), 
    poknj_nezap_neto_lpod decimal(18,2),
    poknj_nezap_obresti_lpod decimal(18,2),
    poknj_nezap_marza_lpod decimal(18,2),
    poknj_nezap_regist_lpod decimal(18,2),
    poknj_nezap_davek_lpod decimal(18,2),
    poknj_nezap_robresti_lpod decimal(18,2)
   )
AS
BEGIN
 ...
 THEN 0 ELSE 1 END) END) ELSE 1 END)) 
     ...
     SET       
          ...
          poknj_nezap_neto_lpod = T.poknj_nezap_neto_lpod,
          poknj_nezap_obresti_lpod = T.poknj_nezap_obresti_lpod,
          poknj_nezap_marza_lpod = T.poknj_nezap_marza_lpod,
          poknj_nezap_regist_lpod = T.poknj_nezap_regist_lpod,
          poknj_nezap_davek_lpod = T.poknj_nezap_davek_lpod,
          poknj_nezap_robresti_lpod = T.poknj_nezap_robresti_lpod
     FROM @Result AS R, 
     (
    SELECT    
        PP.id_cont, 
        ...
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_neto_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_neto_lpod,
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_obresti_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_obresti_lpod,
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_marza_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_marza_lpod,
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_regist_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_regist_lpod,
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_davek_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_davek_lpod,
        SUM(dbo.gfn_Xchange(@par_tecajnica_tecajnica, PP.poknj_nezap_robresti_lpod, PP.ID_tec, @par_tecajnica_datumtec)) AS poknj_nezap_robresti_lpod
