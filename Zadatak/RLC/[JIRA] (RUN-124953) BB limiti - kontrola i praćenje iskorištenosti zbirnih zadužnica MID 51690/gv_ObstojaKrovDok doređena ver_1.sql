if exists (select * from sys.objects where name = 'gv_ObstojaKrovDok' and type = 'V') drop view gv_ObstojaKrovDok
GO
/*--------------------------------------------------------------------------------------------------------
...
16.08.2024 g_tomislav; MID 52121 - added columns id_cont and id_obl_zav
--------------------------------------------------------------------------------------------------------*/
...
select
    ...
    d.VREDNOST, d.id_cont, d.id_obl_zav
from
    dbo.dokument d
