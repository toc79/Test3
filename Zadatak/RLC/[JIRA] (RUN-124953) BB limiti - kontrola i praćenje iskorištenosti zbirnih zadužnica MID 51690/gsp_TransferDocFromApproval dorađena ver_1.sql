if exists (select * from sys.objects where name = 'gsp_TransferDocFromApproval' and type = 'P') drop procedure  dbo.gsp_TransferDocFromApproval
go
-----------------------------------------------------------------------------------
...
-- g_tomislav; 19.08.2024 - MID 52121
-----------------------------------------------------------------------------------
