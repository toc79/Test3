...
** 22.08.2023. g_igorp MR51199 micanje troška IK
...
**********************************************************************************
** Created: unknown
** 22.03.2023 g_tomislav MID 50458 - obrisan je zakomentiran kod 
********************************************************** 
...
***************************************************
** MORA OBAVEZNO BITI NA KRAJU EXT_FUNC-a
** ALIAS ide samo jednom na kraju ili ako postoji RETURN .F. onda prije svakog RETURN-a da se vrati na default kursor koji je neophodan za masku
** 22.03.2023 g_tomislav MID 50458 

IF !EMPTY(lcStariAlias) THEN
	SELECT (lcStariAlias)
ENDIF

**END ext_func POGODBA_MASKA PREVERI_PODATKE
***************************************************