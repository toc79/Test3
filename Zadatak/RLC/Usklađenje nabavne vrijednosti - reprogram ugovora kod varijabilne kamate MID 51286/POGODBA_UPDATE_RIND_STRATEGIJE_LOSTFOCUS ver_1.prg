...
* 21.12.2020 g_tomislav MID 45222 - Rind_strategije
...
* 10.10.2023 g_tomislav MID 51431 - bugfix kada je pogodba.Rind_dat_next = NULL
***********************************************************************************
...
IF pogodba.id_rind_strategije != lnId_rind_strategije OR NVL(TTOD(pogodba.Rind_dat_next), {1.1.1901}) != ldRind_dat_next
