...
INSERT INTO dbo._tmp_kategorije VALUES ('U2', '01519/07', NULL, NULL, NULL, NULL, '2007-02-08')
UPDATE _tmp_kategorije SET id_entiteta = dbo.gfn_id_cont4id_pog(id_pog)



*Kandidati će biti kao u excelu
select * from _tmp_kategorije 
where id_entiteta is not null

*PROMJENA SQL = REZULTAT?
select c.id_entiteta, a.entiteta , c.val_datetime_new, a.id_kategorije_tip
