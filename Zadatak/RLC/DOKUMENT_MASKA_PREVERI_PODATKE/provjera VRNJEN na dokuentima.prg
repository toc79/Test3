...
obvesti ("okviri koji imaju krovnu dokumentaciju")
...
obvesti ("IF: "+trans(RECCOUNT("_okvir_krovni_dokument") - iif(GF_NULLOREMPTY(ldVrnjen_baza), 1, 0) == RECCOUNT("_okvir_krovni_dokument_sa_popunjenim_vrnjen") and ldVrnjen != NVL(ldVrnjen_baza, {01.01.1900})		))		

obvesti ("IF 1 _okvir_krovni_dokument: "+trans(RECCOUNT("_okvir_krovni_dokument") )) && 4
&& -
obvesti ("IF 1 ldVrnjen_baza: "+trans(iif(GF_NULLOREMPTY(ldVrnjen_baza), 1, 0) )) && 1
*== 
obvesti ("IF 2: "+trans(RECCOUNT("_okvir_krovni_dokument_sa_popunjenim_vrnjen") )) && 2
*and
obvesti ("IF 3: "+trans( ldVrnjen != NVL(ldVrnjen_baza, {01.01.1900})		))	 && .T.
...
obvesti ("da li je popunjen datum vraćanja na zadnjem krovnom dokumentu ili ako su svi krovni dokumenti popunjeni ali se mjenja unešeni podatak")
