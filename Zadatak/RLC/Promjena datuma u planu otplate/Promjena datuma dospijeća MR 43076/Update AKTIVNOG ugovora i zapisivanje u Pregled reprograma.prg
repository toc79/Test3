...
WHERE dni_zap = 8 --provjeriti i suprotno
*********************************************************************************************************
...
SCAN
	...
	lcNovaVrijednost=rezultat.dni_zap_new
	...
	*ukoliko ima potrebe
	...
	lcOpomba="Promjena broja dana dospijeæa prema zahtjevu 2032 (MR 43076)"
	...
	GF_SQLEXEC("Select * From pogodba where id_cont="+GF_QuotedStr(lnid_cont),"_pogodba_copy")
		...
		&&ENDIF
	replace DNI_ZAP with lcNovaVrijednost in _pogodba
