**********************************************
**07.07.2021 g_tomislav MID 47147 - provjera potražnog salda za konto 290007 za trošak 03 ODRŽAVANJE 
...
IF RECCOUNT("_ef_kandidati") > 0
	...
	select a.id_cont, a.id_pog, a.sum_znesek, b.potrazni_saldo ;
	from _ef_kandidati a ;
	inner join _ef_gl b on a.id_cont = b.id_cont; && napraviti left join i NVL 0 za ugovore bez uknjižba na kontu
