...
declare @from datetime = '20210101'
declare @to datetime = '20211001'
declare @enabled_id_vrst_dod_str bit = 1
declare @id_vrst_dod_str varchar(200) = '01,02'
...
where a.dat_aktiv between @from and @to
and a.source_tbl = 'gl_input_rk'
and irk.id_vrst_dod_str is not null
and (0 = @enabled_id_vrst_dod_str OR charindex(irk.id_vrst_dod_str, @id_vrst_dod_str) > 0)
order by a.id_gl_razmej 

--select * from dbo.gl_razmej
--select naziv, id_vrst_dod_str from dbo.vrst_dod_str 