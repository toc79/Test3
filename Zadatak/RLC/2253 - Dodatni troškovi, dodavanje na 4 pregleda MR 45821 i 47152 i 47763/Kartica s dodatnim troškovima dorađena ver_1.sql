...
-- 09.05.2022 g_tomislav MID 47763 - replaced g.SOURCE_TBL = 'gl_input_rk' with r.vrsta_dok = 'PFA'. Added join on arh_gl_input_r and for dbo.arh_gl_input_rk is now joined on dbo.arh_gl_input_r and on id_cont and raz_pkonto
