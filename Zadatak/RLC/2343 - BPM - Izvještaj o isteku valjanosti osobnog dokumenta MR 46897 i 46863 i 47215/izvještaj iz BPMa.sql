--21.06.2021 g_tomislav MID 46897 - created;
...
--4. Zakonski zastupnik/punomoæenik - 1.
...
and def_name in ('assignee_nova_id1', 'assignee_desc', 'assignee_oib', 'assignee_address', 'assignee_place' --nema emso
	, 'assignee_work_place' -- uloga bi valjda bila '4. Zakonski zastupnik/punomoæenik - 1.' 
...
select process_instance_id, process_date_created, assignee_nova_id1, assignee_desc, assignee_oib, assignee_address, assignee_place, assignee_work_place, assignee_personal_doc_type, assignee_personal_doc_id, assignee_personal_doc_department, assignee_personal_doc_date, '4. Zakonski zastupnik/punomoæenik - 1' as uloga 
...
pivot (max(val_str) for def_name in ([assignee_nova_id1], [assignee_desc], [assignee_oib], [assignee_address], [assignee_place] --nema emso
	, [assignee_work_place] -- uloga bi valjda bila '4. Zakonski zastupnik/punomoæenik - 1.' 
	, [assignee_personal_doc_type], [assignee_personal_doc_id] -- nema Datum izdavanja osob. dok.
	, [assignee_personal_doc_department], [assignee_personal_doc_date])) as PivotTable
--select * from #assigneePivot

--4. Zakonski zastupnik/punomoæenik - 2.
select process_instance_id, process_date_created, def_name, val_str--, def_title 
into #assignee2
from dbo.gv_bpm_data_field_instance dfi (nolock)
where exists (select *
...
and def_name in ('assignee_nova_id2', 'assignee_desc2', 'assignee_oib2', 'assignee_address2', 'assignee_place2' --nema emso
	, 'assignee_work_place2' -- uloga bi valjda bila '4. Zakonski zastupnik/punomoæenik - 1.' 
...
pivot (max(val_str) for def_name in ([assignee_nova_id2], [assignee_desc2], [assignee_oib2], [assignee_address2], [assignee_place2] --nema emso
	, [assignee_work_place2] -- uloga bi valjda bila '4. Zakonski zastupnik/punomoæenik - 1.' 
	, [assignee_personal_doc_type2], [assignee_personal_doc_id2] -- nema Datum izdavanja osob. dok.
	, [assignee_personal_doc_department2], [assignee_personal_doc_date2])) as PivotTable
--select * from #assigneePivot2

--2.2 Vlasnièka struktura - fizièke osobe - 1
select process_instance_id, process_date_created, def_name, val_str--, def_title 
...
select process_instance_id, process_date_created, related_fo_manage_nova_id1, related_fo_manage_desc1, related_fo_manage_oib1, related_fo_manage_address1, related_fo_manage_place1, '' as assignee_work_place, '' as assignee_personal_doc_type, related_fo_manage_ident_doc1, related_fo_manage_id_doc_issuer1,	related_fo_manage_id_doc_date1, '2.2 Vlasnièka struktura - fizièke osobe - 1' as uloga into #related_fo_manage_1Pivot from #related_fo_manage_1
pivot (max(val_str) for def_name in ([related_fo_manage_nova_id1], [related_fo_manage_desc1], [related_fo_manage_oib1], [related_fo_manage_address1], [related_fo_manage_place1]
	, [related_fo_manage_ident_doc1], [related_fo_manage_id_doc_issuer1], [related_fo_manage_id_doc_date1])) as PivotTable
--select * from #related_fo_manage_1Pivot

--2.2 Vlasnièka struktura - fizièke osobe - 2
select process_instance_id, process_date_created, def_name, val_str--, def_title 
...
select process_instance_id, process_date_created, related_fo_manage_nova_id2, related_fo_manage_desc2, related_fo_manage_oib2, related_fo_manage_address2, related_fo_manage_place2, '' as assignee_work_place, '' as assignee_personal_doc_type, related_fo_manage_ident_doc2, related_fo_manage_id_doc_issuer2,	related_fo_manage_id_doc_date2, '2.2 Vlasnièka struktura - fizièke osobe - 2' as uloga into #related_fo_manage_2Pivot from #related_fo_manage_2
pivot (max(val_str) for def_name in ([related_fo_manage_nova_id2], [related_fo_manage_desc2], [related_fo_manage_oib2], [related_fo_manage_address2], [related_fo_manage_place2]
	, [related_fo_manage_ident_doc2], [related_fo_manage_id_doc_issuer2], [related_fo_manage_id_doc_date2])) as PivotTable
--select * from #related_fo_manage_2Pivot

--2.2 Vlasnièka struktura - fizièke osobe - 3
select process_instance_id, process_date_created, def_name, val_str--, def_title 
...
pivot (max(val_str) for def_name in ([related_fo_manage_nova_id3], [related_fo_manage_desc3], [related_fo_manage_oib3], [related_fo_manage_address3], [related_fo_manage_place3]
	, [related_fo_manage_ident_doc3], [related_fo_manage_id_doc_issuer3], [related_fo_manage_id_doc_date3])) as PivotTable
--select * from #related_fo_manage_3Pivot

--2.2 Vlasnièka struktura - fizièke osobe - 4
select process_instance_id, process_date_created, def_name, val_str--, def_title 
...
pivot (max(val_str) for def_name in ([related_fo_manage_nova_id4], [related_fo_manage_desc4], [related_fo_manage_oib4], [related_fo_manage_address4], [related_fo_manage_place4]
	, [related_fo_manage_ident_doc4], [related_fo_manage_id_doc_issuer4], [related_fo_manage_id_doc_date4])) as PivotTable
...
--FINAL NOVA AND BPM
select * from #finalBPM
/* ZADATAK JE IZ BPMa, za ostale iz NOVA imaju pregled partnera valjda 
union all 
--za koje ne postoje u BPMu, a koji pak imaju istekli osobni dokument
select par.id_kupca, par.naz_kr_kup, par.neaktiven as status, pog.broj_ad_ugovora
	, par.tip_os_izk, gr_os_izk.value as Vrsta_osob_dok, st_os_izk as Broj_osob_dok, par.d_os_izk as Datum_izdavanja_osob_dok
	, par.izd_os_izk as Izdavatelj_osob_dok, par.d_velj_os_izk as Datum_valjanosti, par.emso as jmbg
	, null, null, null, null, null, null, null, null, null, null, null, null, null
from {1}.dbo.partner par
outer apply (select {1}.dbo.gfn_StringToFOX(value) as value from {1}.dbo.general_register where id_register = 'OS_IZK' and id_key = par.tip_os_izk) gr_os_izk
outer apply (select count(*) as broj_ad_ugovora from {1}.dbo.pogodba where status_akt in ('D', 'A') and id_kupca = par.id_kupca) pog
where not exists (select * from #finalBPM where id_kupca = par.id_kupca)
and d_velj_os_izk < @today
*/
