...
*INSERT INTO dbo.general_register(ID_REGISTER,ID_KEY,VALUE,VAL_BIT,VAL_NUM,VAL_CHAR,neaktiven,val_datetime) VALUES('RLC Reporting list','RLC_REKLAS_DOD_STR','Lista konta koja se koriste za knjiženje dodatnih troškova u GK kod reklasificirane ugovore (OR)',0,NULL,'412404,418103,418104,452003,452004',0,NULL)
INSERT INTO dbo.general_register(ID_REGISTER,ID_KEY,VALUE,VAL_BIT,VAL_NUM,VAL_CHAR,neaktiven,val_datetime) VALUES('RLC Reporting list','RLC_DOD_STR_KONTO_RAZMEJ','Lista konta koja se koriste za knjiženje dodatnih troškova na razgraničenjima',0,NULL,'190401,190002',0,NULL)
...
** 01.06.2020 Tomislav MID 44249 RLHR #2120 - dodana provjera za konta razgraničenja iz RLC_DOD_STR_KONTO_RAZMEJ. Promjena 2. kontrole da se radi i za gl_input_r.vrsta_rac!='FLE'. Isključivanje 3. kontrole
**********************************************
