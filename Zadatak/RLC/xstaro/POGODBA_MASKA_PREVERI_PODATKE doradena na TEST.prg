...
obvesti ("Opći uvjeti prije aut. promjene: "+allt(pogodba.spl_pog))
...
obvesti ("Prije kursora")
if used('_ef_partner_list') then
	return
endif

obvesti ("Poslije kursora")
...
obvesti ("Opći uvjeti POSLIJE aut. promjene: "+allt(pogodba.spl_pog)+". Šifra kupca: "+allt(_ef_partner_list.id_kupca))
...
SELECT cur_extfunc_error
REPLACE ni_napaka WITH .F. IN cur_extfunc_error
POZOR("Spremanje ugovora je trenutno onemogućeno radi testiranja kontrola.")
