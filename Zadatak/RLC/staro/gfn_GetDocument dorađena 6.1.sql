--USE [NOVA_PROD]
--GO
--/****** Object:  UserDefinedFunction [dbo].[gfn_GetDocument]    Script Date: 13.2.2019. 15:46:10 ******/
SET ANSI_NULLS ON
GO
...
-- 14.02.2019 g_tomislav; MR 42034 bugfix - changed OPIS1 varchar(4000) and OPOMBE varchar(2000) to varchar(max)
------------------------------------------------------------------------------------------------------------
