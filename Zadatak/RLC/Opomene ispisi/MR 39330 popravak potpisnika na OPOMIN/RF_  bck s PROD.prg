...
**MID 38251, izmjena RF_TIP_POG da koristi gfn_Nacin_leas_HR
...
*17.10.2016 g_tomislav MR 36540, napomena: koristi se samo na ispisu Povrat instrumenata osiguranja POV_INS_OSIG.DOC
...
ENDFUNC
***********************************************
** g_barbarak, ispis adrese za zadužnice
FUNCTION RF_ADRESA()
 RETURN 'Radnička cesta 43'
ENDFUNC
***********************************************