...
**************************************************
* 20.01.2020 g_tomislav MR 43505 - created and modify;
**************************************************
IF loForm.repro_type = "2" THEN  && type of reprogram: 1= manual 2 = automatic
	...
	*_cliptext = lcXMLresult
	...
	IF _ef_automatic_rpg.new_interest_rate != _ef_pogodba.obr_mera OR !GF_NULLOREMPTY(_ef_automatic_rpg.new_index_rate) OR !GF_NULLOREMPTY(_ef_automatic_rpg.new_index_date)
		...
		lnNew_index_rate = IIF(ISNULL(_ef_automatic_rpg.new_index_rate) OR (EMPTY(_ef_automatic_rpg.new_index_rate) AND _ef_automatic_rpg.new_index_rate = 0) , _ef_pogodba.rind_zadnji, _ef_automatic_rpg.new_index_rate) && ne koristiti GF_NULLOREMPTY zato jer EMPTY numeric polje vraća T kada je iznos 0
