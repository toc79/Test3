...
*///////////////////////////////////////////////
* 23.01.2020 g_tomislav MR 43505 - created and modify;
*///////////////////////////////////////////////
...
obvesti ("ISNULL(_ef_automatic_rpg.new_index_rate) => "+trans(ISNULL(_ef_automatic_rpg.new_index_rate)) + gce ;
+"GF_NULLOREMPTY(_ef_automatic_rpg.new_index_rate) => "+trans(GF_NULLOREMPTY(_ef_automatic_rpg.new_index_rate)) + gce ;
+"EMPTY(_ef_automatic_rpg.new_index_rate) => "+trans(EMPTY(_ef_automatic_rpg.new_index_rate)) + gce ;
+"_ef_automatic_rpg.new_index_rate = 0 => "+trans(_ef_automatic_rpg.new_index_rate = 0) + gce ;
+"_ef_pogodba.rind_zadnji => "+trans(_ef_pogodba.rind_zadnji) +gce ;
+"_ef_automatic_rpg.new_index_rate => "+trans(_ef_automatic_rpg.new_index_rate) + gce ;
+"lnNew_index_rate => "+ trans(lnNew_index_rate ) +gce ;
+"GF_NULLOREMPTY(_ef_automatic_rpg.new_index_date) => "+trans(GF_NULLOREMPTY(_ef_automatic_rpg.new_index_date)) ;
) ;
