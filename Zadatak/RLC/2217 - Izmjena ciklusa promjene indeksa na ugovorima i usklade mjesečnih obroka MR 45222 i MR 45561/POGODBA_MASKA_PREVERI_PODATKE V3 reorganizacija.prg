...
* 02.10.2020 g_tomislav MR 45561 (MR 45222) - reorganizacija kontrola zbog greške uzrokovane korištenjem varijable lcSQL2 u kontroli za Rind_strategije. Sljedeće tri linije koda sam zakomentirao zato jer su nepotrebne: nakon što se kreira kursor _ef_partner_list, isti se uništi u kodu USE IN _ef_partner_list (koji je postojao od prije)
* if used('_ef_partner_list') then
	* return
* endif

* Komentar: ako se u gornjoj provjeri setira, da li je uopće potrebna donja provjera ? Vjerojatno je kontrola postojala prije setiranja iznad, ali se nije maknula
