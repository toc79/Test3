...
and
a.date_entered >= (select ISNULL(min(date_inserted),getdate()-1) as max_date_inserted from dbo.xdoc_run_history Where status='C' and id_xdoc_template = @id_xdoc_template)
