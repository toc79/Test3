select * from dbo.KRED_POG where ID_KREDPOG = '0270 22'
...
--select * From dbo.KRED_POG where ID_KREDPOG = '0257 22'

select * from dbo.tecajnic
TEČAJEVI SU ISTI TAKO DA MOŽE IĆI ISTI IZNOS, TESTIRAO I KOD NJIH
...
where kp.ID_KREDPOG = '0270 22' --'0253 21'
--and ID_POG='67169/22'
and pog.id_cont in (76382, 76385)
-- provjere
--and a.iznos_akolacije = pog.NET_NAL_zac --svi
and pkp.id_cont is null -- ne smije biti alokacije
--and pog.NET_NAL = pog.net_nal_zac -- 
