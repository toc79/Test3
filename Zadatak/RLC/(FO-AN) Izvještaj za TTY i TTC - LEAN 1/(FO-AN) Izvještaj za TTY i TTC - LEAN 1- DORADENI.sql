...
SET @unos_oznacen = 1 --{0}
SET @date_from_unos = '20170101'--{1}
SET @date_to_unos = '20170131'--{2}
SET @promjena_oznacen = 0 --{3}
...
DATEDIFF(dd, wh.dkn_unos, wh.dkc_unos) as razlika_dkn_dkc, --17 Broj dana od DKN do DKC
DATEDIFF(hh, wh.dkn_unos, wh.dkc_unos) as razlika_dkn_dkc_sati, --18 Broj sati od DKN do DKC
...
LEFT JOIN
	...
	MIN(CASE WHEN a.id_status_new = 'ODO' THEN a.date_started ELSE NULL END) as odo_unos, --Odobreno
