...
/*
-- SQL SHOW 
-- AKO NEĆE RUČNO POKRETATI; TAJ SELECT JE NEPOTREBAN ZAPRAVO NITI MOGU RUČNO POKRETATI JER PATH ZA DATOTEKU VIŠE NE SADRŽI DOKUMENTE NA TOJ LOKACIJI VEĆ U ARCHIVE FOLDERU (moglo bi se podesiti i ručno pokretanje) TAKO DA ĆU TO MAKNUTI
-- EVENTUALNO AKO IM SE PODESI DA DATOTEKE POSTAVE NA NEKU LOKACIJU I DA TO PODRŽOMO U SELECTIMA
*/
-- SQL SHOW 
-- 05.10.2023 g_tomislav MID 50697 - created;
...
order by eef.id_kupca, eef.document_id
...
--SQL EXPORT
-- 25.10.2023 g_tomislav MID 50697 - created;
