...
IF @DocType = 'General' AND @ReportName = 'OBV_ISTEK_SSOFT_RLC'
BEGIN
	SELECT '0033' AS [tip_dokumenta],
		'1' AS [edoc.dms],
		CASE WHEN @eom_blockade = 0 THEN '0' ELSE '1' End [edoc.filter_field],
		'0' AS [edoc.for_web],
		'0' AS [edoc.not_print],
		RTRIM(par.id_kupca) + '_0033_' + rtrim(@Id) +'.pdf' AS print_centar_name,
		par.id_kupca AS partner_id,
		par.naz_kr_kup AS partner_title,
