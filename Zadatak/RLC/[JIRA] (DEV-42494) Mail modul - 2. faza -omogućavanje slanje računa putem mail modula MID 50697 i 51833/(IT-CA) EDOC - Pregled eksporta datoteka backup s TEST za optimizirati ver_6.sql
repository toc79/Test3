...
left join dbo.xdoc_document xdd_OBV_IND on a.id_file = xdd_OBV_IND.doc_id and xdd_OBV_IND.id_xdoc_template = 57 and xdd_OBV_IND.date_exported >= a.date_prepared
left join dbo.xdoc_document xdd_LOBR on a.id_file = xdd_LOBR.doc_id and xdd_LOBR.id_xdoc_template = 60 and xdd_LOBR.date_exported >= a.date_prepared
