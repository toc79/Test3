...
gf_sqlexec("select a.id_cont,a.id_poroka,a.vloga,a.oznaka,a.opis,b.naz_kr_kup,b.ulica,b.id_poste,b.mesto from dbo.pog_poro a INNER JOIN dbo.partner b on a.id_poroka=b.id_kupca where a.oznaka='A' and a. neaktiven = 0 and a.id_cont in ("+iif(len(alltrim(opomin_list))=0,"0",opomin_list)+")","_za_opom_poro")
