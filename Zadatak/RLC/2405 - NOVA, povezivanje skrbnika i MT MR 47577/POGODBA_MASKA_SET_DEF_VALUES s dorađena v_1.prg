...
*********************************************
* 12.11.2021 g_tomislav MID 47577 - mjesto troška ugovora se postavlja prema kategorija4 od skrbnika 1 partnera s ponude

IF !GF_NULLOREMPTY(ponudba.id_kupca)
	TEXT TO lcSql NOSHOW
		select s1.kategorija4 --, pon.id_kupca, par.naz_kr_kup, par.skrbnik_1
		from dbo.ponudba pon
		inner join dbo.partner par on pon.id_kupca = par.id_kupca
	...
	lcMT = GF_SQLEXECScalarNull(lcSql +gf_quotedstr(ponudba.id_pon))
	
	IF !GF_NULLOREMPTY(lcMT)
		REPLACE pogodba.id_strm WITH lcMT IN pogodba
	ENDIF 
ENDIF
*******END MID 47577***************************