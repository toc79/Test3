...
begin
	declare @id_kupca char(6) = '036651'
	...
	or id_cont in (72208,72209)
	order by pog.id_cont
	select * from dbo.fa where id_fa = 35880
	select * from dbo.fa_dnev where id_fa = 35890
