...
IF _ef_CalculatedMaxAllowedIR.max_ir_used 
	POZOR("Kamatna stopa (" +ALLT(TRANS(_ef_CalculatedMaxAllowedIR.dej_obr, gcOM)) +") je viša od maksimalno dozvoljene kamatne stope (" +ALLT(TRANS(_ef_CalculatedMaxAllowedIR.max_allowedIR, gcOM)) +")." +gce +"Ugovor se ne može aktivirati!")
