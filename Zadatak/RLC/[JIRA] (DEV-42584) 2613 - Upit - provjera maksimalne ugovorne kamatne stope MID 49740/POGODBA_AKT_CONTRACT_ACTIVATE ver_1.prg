...
***********************************************************************************
** 27.12.2023 - g_tomislav MID 49740 - provjera na zakonsku dozvoljenu kamatnu stopu (based from GF_MaxAllowedIR(ponudba.dej_obr, ponudba.vr_val, ponudba.je_foseba, nacini_l.tip_knjizenja, pogodba.dat_sklen, 0))
...
IF _ef_CalculatedMaxAllowedIR.max_ir_used 
	POZOR("Kamatna stopa (" +ALLT(TRANS(lnDej_obr, gcOM)) +") je viša od maksimalno dozvoljene kamatne stope (" +ALLT(TRANS(_ef_CalculatedMaxAllowedIR.max_allowedIR, gcOM)) +")." +gce +"Ugovor se ne može aktivirati!")
