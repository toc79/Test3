...
** 03.11.2021 g_tomislav MID 47778 - corrected calculation of KREDIT_NETO for OF leasing type and for take over contracts 
...
SELECT --A.ID_CONT, A.ID_VRSTE, A.ID_KUPCA, 
	...
	E.DDV_ID, E.DATUM, 
	case when a.nacin_leas = 'OF' and (a.prevzeta != '' or E.KREDIT_NETO is null) then isnull(of1.sum_kredit_dom, 0) else E.KREDIT_NETO end AS KREDIT_NETO, 
