-- 18.08.2021 g_tomislav MID - u polje znesek_net_pdv i znesek_net je u zbroj dodan c.mstr; znesek_net_pdv se sada izračunava samo u slučaju c.dav_tip = 'D'
...
SELECT a.ID_FAKT, a.ID_KUPCA, a.ID_CONT, a.DATUM_DOK, a.DAT_ZAP, a.DDV_DATE, a.DDV_ID, a.ST_DOK, 
	...
	c.opis,
	c.id_fak_pos,
	dbo.gfn_xchange('000', c.znesek_net + c.mstr, a.id_tec, a.datum_dok) as znesek_net,
	dbo.gfn_xchange('000', c.robresti, a.id_tec, a.datum_dok) as znesek_robresti,
	CASE WHEN c.dav_tip = 'D' THEN dbo.gfn_xchange('000', c.znesek_net + c.mstr, a.id_tec, a.datum_dok)*h.davek/100 ELSE 0.00 END as znesek_net_pdv,
	c.proc_mstr,
	...
	dbo.pfn_gmc_hub3_BarCode(a.id_kupca, n.dom_valuta, a.za_placilo, 'HR01', RTRIM(f.sklic), 'OTHR', 'Plaćanje računa') as barkod_value
FROM dbo.FAKTURE a
