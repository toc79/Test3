...
if @DocType = 'Contract' and @ReportName = 'PROM_OTPL_FL_SSOFT_RLC'
begin
...
Begin
		...
		begin 
			...
			begin 
				...
				--TODO OVAJ DIO PO LEASING KUĆI
				--RL HR NEMA UOPĆE SLIJEDEĆI DIO
...
begin 
		...
		Select * into #najem_fa1 From dbo.pfn_gmc_Print_InvoiceForInstallments(GETDATE()) where ddv_id in (Select ddv_id From dbo.ZBIRNIKI where ID_ZBIRNIK = @id) 
