...
from b2rl.dbo.b2faprod where client_id = @entity_code

insert into #b2glaccount 
select konto,naziv,group_product_type_id,table_name,saldo_debit,customer_id
from b2rl.dbo.b2glaccount where client_id = @entity_code
...
case when a.ex_nacin_leas_tip_knjizenja = '1' and b2rl.dbo.gfn_MR_ol2fl(@entity_code, a.ex_nacin_leas_tip_knjizenja, a.dat_aktiv, a.nacin_leas, a.aneks, a.id_cont) = 0 then 1 else 0 end as real_oper_leas,
...
sum(case when a.realestate_elligible_flag=1 and  a.equipment_type in ('3002') and b.rre_elligible>=a.contract_claims and 
	CASE WHEN a.b2_total_exposure_eur != 0 THEN (a.lt_prov_60_89+a.lt_prov_90_119+a.lt_prov_120_179+a.lt_prov_180_364+a.lt_prov_365+a.tr_prov)/a.b2_total_exposure_eur ELSE 0 END >=0.2
