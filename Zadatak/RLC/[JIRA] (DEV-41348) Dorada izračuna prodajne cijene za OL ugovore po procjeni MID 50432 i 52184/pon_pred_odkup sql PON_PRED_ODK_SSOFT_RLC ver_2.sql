...
SELECT
	...
	ppo.dodatne_ter * (1+(ISNULL(ds.davek, 0)/100)) as dodatne_ter_bruto,								
	---------------------------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------------------------
OUTER APPLY(SELECT val_char AS document_id FROM dbo.gfn_g_register_active_v('BARCODE_REPORTS_RLHR','') WHERE id_key = 'PON_PRED_ODK_SSOFT_RLC') gr_barcode
