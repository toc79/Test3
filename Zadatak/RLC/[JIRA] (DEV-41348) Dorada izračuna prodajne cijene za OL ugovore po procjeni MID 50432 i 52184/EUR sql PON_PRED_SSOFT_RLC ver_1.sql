...
SET @ukupno_sa_pdv_ne_u_rati = (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))-@robresti_sum)+(@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))-@robresti_sum)*(@id_dav_st/100)

SET @ukupno_sa_pdv_u_rati = (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100))-@robresti_sum)+ (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100))-@robresti_sum)*(@id_dav_st/100)
...
SET @ukupno_ol_ne_u_rati = (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))-@robresti_sum)+(@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))-@robresti_sum)*(@id_dav_st/100)+@robresti_sum

SET @ukupno_ol_u_rati = (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100))-@robresti_sum)+ (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100))-@robresti_sum)*(@id_dav_st/100)+@robresti_sum

SET @ukupno_fl_ne_u_rati = @zam_obr_sum+@ze_zapadlo_net_val_sum

SET @ukupno_fl_u_rati = (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100)))+ (@vopc_disk_vred_sum+@varscina2_sum+@str_odv_s_pdv+@str_sod+@str_man_s_pdv+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100))+((@varscina2_sum + @vopc_disk_vred_sum) * (@str_proc/100)*(@id_dav_st/100)))*(@id_dav_st/100)+@zam_obr_sum+@ze_zapadlo_net_val_sum
