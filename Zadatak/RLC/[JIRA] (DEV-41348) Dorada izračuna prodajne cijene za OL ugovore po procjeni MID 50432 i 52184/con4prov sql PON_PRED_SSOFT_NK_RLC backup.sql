...
str_sod_EUR_MIG.res_print as str_sod_RES_PRINT,
ROUND(str_sod_EUR_MIG.res_amount,2) as str_sod_RES_AMOUNT,
str_sod_EUR_MIG.res_exch as str_sod_RES_EXCH,
str_sod_EUR_MIG.res_id_val as str_sod_ID_VAL,
...
OUTER APPLY dbo.pfn_gmc_xchangeEurMigrationPrintouts2(a.id_tec, a.str_sod, a.datum_ponudbe, par.vr_osebe,a.id_cont) as str_sod_EUR_MIG
