...
FOR i = 1 TO _Screen.FormCount
	...
	IF UPPER(_Screen.Forms(i).Name) == "PON_PRED_ODKUP" THEN
		...
		** 03.07.2023 g_tomislav MID 50432 - postavljanje lnNew bez pitanja za korisnika
		...
		IF _Screen.Forms(i).pgfPonudba.Page1.txtDodTer.value <> 0 THEN
			...
			IF loForm.pgfPonudba.Page1.txtDodTer.value != lnNew 
				OBVESTI('Bruto iznos dodatnih troškova se promijenio iz '+allt(trans(lnold,gccif))+' '+lcVal+' u neto iznos '+allt(trans(lnNew,gccif))+' '+lcVal+'!') 
