...
select process_instance_id, process_date_created, def_name, 'Ime i prezime kontakt osobe' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str  
...
select process_instance_id, process_date_created, def_name, '1. Tvrtka društva' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '2. Tvrtka društva' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str 
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '3. Tvrtka društva' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str 
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '4. Tvrtka društva' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '1. Ime i prezime (Vlasnička struktura - fizičke osobe)' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '2. Ime i prezime (Vlasnička struktura - fizičke osobe)' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '3. Ime i prezime (Vlasnička struktura - fizičke osobe)' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '4. Ime i prezime (Vlasnička struktura - fizičke osobe)' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '1. Ime i prezime' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '2. Ime i prezime' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '3. Ime i prezime' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '1. Pravna osoba' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '2. Pravna osoba' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
...
select process_instance_id, process_date_created, def_name, '3. Pravna osoba' as uloga, ltrim(rtrim(def_field_group)) as def_field_group, val_str
from dbo.gv_bpm_data_field_instance dfi (nolock)
where process_id = 'zspnft_parent_rlhr'
