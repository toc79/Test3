-- 11.12.2023 g_tomislav - created based on g_branisl script with few modification

declare @ddv_id varchar(14) = '20230068097' --{3}
declare @prevzeta_id_cont int

select prevzeta, dbo.gfn_Id_cont4Id_pog(prevzeta) as prevzeta_id_cont
	, *
from dbo.pogodba pog
inner join dbo.planp pp on pog.id_cont = pp.id_cont -- event ide prije zapisivanja ddv_id-a u dbo.fakture pa je korišten join na planp
where pog.nacin_leas = 'TP' 
and pp.id_terj = '31'
and pp.ddv_id = @ddv_id
